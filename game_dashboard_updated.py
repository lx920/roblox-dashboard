...
# --------------------------
# KEY METRICS (UPDATED: Median MAPE)
# --------------------------
...
with col1:
    ...
    # Use colors only for tiers present in filtered data
    tier_color_map = {
...
# --------------------------
# DATA TABLE (UPDATED: Only MAPE 30d)
# --------------------------
...
columns_to_show = [
    ...
    'Peak_CCU',
    'Pred_Days_Available',
    'MAPE_30d',  # Only show 30-day MAPE
    'Growth_Score',
    'Stability_Score',
...
# Add retention columns if they exist
for col in df_filtered.columns:
    if 'Retention' in col or 'retention' in col:
        columns_to_show.append(col)

# Filter the dataframe to only show desired columns
